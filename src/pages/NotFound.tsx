...
function NotFound() {
  ...
  return (
    <>
      ...
      <div className=" h-screen min-h-[300px] flex justify-center flex-col items-center font-mainBold text-main">
        ...
        <div className="flex gap-2">
          <Link to={"/"}>
            <button className="h-[40px] px-5 mt-5 rounded-md text-buttonText bg-main transition-colors text-[14px] hover:bg-mainHover">
