...
export default function SearchCard({ product }: { product: TProductCard }) {
  ...
  return (
    <div
      ...
      } h-[200px] mediumSmall:h-[170px] searchCardLow:h-[135px] mediumSmallXl:w-full  p-3 searchCardLow:p-0 w-[calc(50%-10px)] rounded-lg border-2 border-cardBorder`}
    >
      <div
        className={`relative w-full h-full flex items-center gap-3 searchCardLow:gap-0 ${
          loaded ? "visible" : "invisible max-h-0 max-w-0"
        } `}
      >
        ...
        <button
          ...
          className=" p-[5px] rounded-md absolute right-0 searchCardLow:right-1 top-0 searchCardLow:top-1"
        >
          <BookmarkIcon
        ...
        <div className="flex flex-col h-full py-1 pb-0 gap-1 w-full searchCardLow:pr-2 searchCardLow:p-2 searchCardLow:gap-0">
          <Link className="w-min" to={"/product/" + product.id}>
            <h3 className="font-mainSemiBold tracking-wider text-textHeadCard searchCardLow:text-[13px] text-[15px]  w-min text-nowrap overflow-hidden text-ellipsis max-w-[200px] searchCardLow:max-w-[130px]">
          ...
          <div className="mt-auto w-full">
            <div className="flex items-center justify-between w-full">
              <p className="text-textDescCard font-mainMedium tracking-wider text-[12px] medium:text-[11px] searchCardLow:max-w-[60px] max-w-[250px] overflow-hidden text-ellipsis text-nowrap">
                {product.estate_city}
            ...
            <div className="flex items-center h-[42px] searchCardLow:h-auto">
              ...
              <div className="flex items-center gap-4 medium:gap-2 ml-auto searchCardLow:gap-1 searchCardLow:justify-end">
                <p className="text-[12px] font-mainMedium tracking-wide text-textDescCard medium:text-[11px] searchCardLow:text-[10px] searchCardLow:tracking-normal ">
                  1 მ² -{" "}
                  {numeral(price.perSize).format("0,0").replace(/,/g, " ")}{" "}
...
function SearchCardSkeleton() {
  return (
    <div className="flex items-center gap-3 searchCardLow:gap-0 h-full w-full">
      <div className="h-full relative skeletonLoad aspect-[1/0.8] mediumSmallXl:aspect-[1/0.65] searchCardLow:aspect-[1/0.9] mobile:aspect-[1/0.8] rounded-lg bg-whiteLoad overflow-hidden shrink-0"></div>
      <button className="skeletonLoad bg-[var(--skeleton3)] h-[24px] aspect-square rounded-[5px] absolute right-2  top-2 "></button>
      <div className="flex flex-col h-full py-1 pb-0 gap-1 w-full searchCardLow:pr-2 searchCardLow:p-2">
        <h3 className="skeletonLoad bg-[var(--skeleton3)] h-[18px] w-[120px] rounded-[5px]"></h3>
        <h3 className="skeletonLoad bg-[var(--mainClear)] h-[18px] w-[80px] rounded-[5px]"></h3>

        <div className="flex gap-2 searchCardLow:gap-1 items-center mt-1 mobile:flex-wrap  searchCardLow:mb-1">
          <div className="skeletonLoad bg-[var(--skeleton3)] h-[18px] w-[40px] rounded-[5px] "></div>
          <div className="skeletonLoad bg-[var(--skeleton3)] h-[18px] w-[40px] rounded-[5px] "></div>
          <div className="skeletonLoad bg-[var(--skeleton3)] h-[18px] w-[40px] rounded-[5px] "></div>
          <div className="searchCardLow:hidden skeletonLoad bg-[var(--skeleton3)] h-[18px] w-[60px] rounded-[5px] "></div>
        </div>
        <div className="mt-auto w-full">
          <div className="flex items-center justify-between w-full">
            <p className="skeletonLoad bg-[var(--skeleton1)] h-[18px] w-[60px] rounded-[5px] "></p>
            <p className="skeletonLoad bg-[var(--skeleton1)] h-[18px] w-[60px] rounded-[5px] "></p>{" "}
          </div>
          <div className="border-t border-cardBorder mt-1"></div>
          <div className="flex items-center h-[42px] searchCardLow:h-auto searchCardLow:pt-1">
            <div className="flex items-center gap-4 medium:gap-2 ml-auto searchCardLow:gap-1 searchCardLow:justify-end">
              <p className="text-[12px] font-mainMedium tracking-wide text-textDescCard medium:text-[11px] searchCardLow:text-[10px] searchCardLow:tracking-normal "></p>
              <h3 className="skeletonLoad bg-[var(--mainClear)] h-[24px] w-[100px] rounded-[5px]"></h3>
            </div>
          </div>
        </div>
      </div>
